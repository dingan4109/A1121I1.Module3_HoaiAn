...
public class CustomerServiceImpl implements CustomerService{
    ...
    static {
        ...
        customerList.put(4,new Customer(4,"Adam","adam@codegym.vn","Beijing"));
        customerList.put(5,new Customer(5,"Sophia","sophia@codegym.vn","Miami"));
        customerList.put(6,new Customer(6,"Rose","rose@codegym.vn","New York"));
    }
    @Override
    public List<Customer> findAll() {
        return new ArrayList<>(customerList.values());
//        => trả về Collection<model.Customer>
    }
