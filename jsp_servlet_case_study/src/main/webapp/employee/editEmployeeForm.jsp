            ...
            <form class="row g-3 border" method="post">
                <div class="col-md-9">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                           placeholder="${employee.getEmployeeName()}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="idCard" name="idCard"
                           placeholder="${employee.getEmployeeIdCard()}">
                </div>
                <div class="col-6">
                    <label for="salary" class="form-label">Salary</label>
                    <input type="text" class="form-control" id="salary" name="salary"
                           placeholder="${employee.getEmployeeSalary()}">
                </div>
                <div class="col-md-6">
                    <label for="phone" class="form-label">Phone</label>
                    <input type="text" class="form-control" id="phone" name="phone"
                           placeholder="${employee.getEmployeePhone()}">
                </div>
                <div class="col-md-6">
                    <label for="email" class="form-label">Email</label>
                    <input type="text" class="form-control" id="email" name="email"
                           placeholder="${employee.getEmployeeEmail()}">
                </div>
                <div class="col-md-12">
                    <label for="address" class="form-label">Address</label>
                    <input type="text" class="form-control" id="address" name="address"
                           placeholder="${employee.getEmployeeAddress()}">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="username" name="username"
                           placeholder="${employee.getUsername()}">
                </div>
                <div class="col-12">
